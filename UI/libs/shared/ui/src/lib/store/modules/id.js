import { GET_ID, ADD_ID, UPDATE_ID, DELETE_ID } from '../mutations/idMutations';
...
export default {
  ...
  actions: {
    /**
     * Used to get currently existing id information from localstorage or an API and put it into the
     * store
